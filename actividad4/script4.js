...
function seriePares() {
    ...
    crearDiv("Pares: " + arrPares.join(", "), "final");
}
...
crearDiv("Fibonacci: " + arrAcum.join(", "), "final"); //Además de arrAcum puedo usar array.toString() y muestra los elementos del array separados por una coma
}
